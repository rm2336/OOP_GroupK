...
public class Evaluation {
    ...
    public String getSummary() {
        ...
        for (int i = 0; i < questions.size(); i++) {
            ...
            summary.append("Correct Answer: ").append(question.getOptions().get(question.getOptions().indexOf(question.checkAnswer(userAnswer) ? userAnswer : question.getOptions().get(0)))).append("\n");
            summary.append("\n");
        }
